...
void Init_Athens()
{
	athens.push_back(Athens(0, 2, 0, 0.3, 0.3, 0.3, 0, 0.4, 0)); // солнце
	athens.push_back(Athens(0, -0.1, -1.2, 0.17, 0.17, 0.17, 0, 0, 0)); //елка
	athens.push_back(Athens(-2, -0.1, -2, 0.8, 0.3, 0.8, 0, 0, 0)); // забор
	athens.push_back(Athens(-1, 0, 1.60, 0.02, 0.02, 0.02, 0, -0.7, 0));// дом
	athens.push_back(Athens(0, 0, 0, 1, 1, 1, 0, 0, 0));
}
...
void render()
{
	...
	light.attenuation = glm::vec3(0.3, 0.3, 0.3);
	...
	/*	GLuint LightPositionID2 = glGetUniformLocation(shaders[i].ShaderProgram, "ligh2t.position");
...
int main(int argc, char** argv)
{
	...
	tex_Paths.push_back("sun.jpg");
	tex_Paths.push_back("igls.jpg");
	tex_Paths.push_back("tx_zb.jpg");
	tex_Paths.push_back("Cottage Texture.jpg");
	tex_Paths.push_back("grass.jpg");
	tex_Path_2 = "tree.jpg";

	Mesh mesh_1 = openOBJ("sun.obj");
	meshes.push_back(mesh_1);

	Mesh mesh_2 = openOBJ("Tree.obj"); 
	meshes.push_back(mesh_2);

	Mesh mesh_3 = openOBJ("L_ZZ.obj");
	meshes.push_back(mesh_3);

	Mesh mesh_4 = openOBJ("Snow covered CottageOBJ.obj");
	meshes.push_back(mesh_4);

	Mesh mesh_5 = openOBJ("plane_4.obj");
